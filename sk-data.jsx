...
const SK_CATEGORIES = [
  {
    ...
    rooms: [
      { id: 'web-01', name: 'SQL Injection Temelleri', difficulty: 'Başlangıç', desc: 'Temel SQLi tekniklerini öğren ve ilk bayrağını yakala.', users: 1420, points: 50, premium: true },
      { id: 'web-04', name: 'XSS (Reflected)', difficulty: 'Başlangıç', desc: 'Reflected XSS ile cookie çalma.', users: 1290, points: 50, premium: true },
      { id: 'web-11', name: 'Varsayılan Parola Sömürüsü', difficulty: 'Başlangıç', desc: 'Router yöneticisinin varsayılan kimlik bilgileriyle giriş yapma.', users: 1150, points: 50, premium: true },
      { id: 'web-12', name: 'Komut Enjeksiyonu Temelleri', difficulty: 'Başlangıç', desc: 'Ping panelinden komut enjeksiyonu ile bayrak okuma.', users: 1080, points: 50, premium: true },
      { id: 'web-13', name: 'Kaynak Kod Analizi', difficulty: 'Başlangıç', desc: 'HTML yorum satırlarında gizlenen bayrağı bulma.', users: 980, points: 50, premium: true },
      { id: 'web-14', name: 'Dizin Geçişi Temelleri', difficulty: 'Başlangıç', desc: '../ ile yol traversal yaparak sunucu dosyalarını okuma.', users: 890, points: 50, premium: true },
      { id: 'web-15', name: 'Çerez Manipülasyonu', difficulty: 'Başlangıç', desc: 'İstemci tarafı çerezleri değiştirerek yetki yükseltme.', users: 820, points: 50, premium: true },
      { id: 'web-02', name: 'UNION-Based SQLi', difficulty: 'Orta', desc: 'UNION SELECT ile çoklu tablo dump etme.', users: 950, points: 75, premium: true },
      { id: 'web-05', name: 'XSS (Stored & DOM)', difficulty: 'Orta', desc: 'Kalıcı XSS ve DOM manipülasyonu.', users: 870, points: 75, premium: true },
      { id: 'web-06', name: 'CSRF Saldırıları', difficulty: 'Orta', desc: 'Cross-Site Request Forgery ile işlem tetikleme.', users: 780, points: 70, premium: true },
      { id: 'web-03', name: 'Blind SQL Injection', difficulty: 'İleri', desc: 'Boolean ve time-based blind injection.', users: 680, points: 100, premium: true },
      { id: 'web-07', name: 'File Upload Bypass', difficulty: 'İleri', desc: 'Dosya yükleme filtrelerini atlatma ve shell alma.', users: 620, points: 100, premium: true },
      { id: 'web-08', name: 'SSRF & XXE', difficulty: 'İleri', desc: 'Server-Side Request Forgery ve XML Entity injection.', users: 580, points: 120, premium: true },
      { id: 'web-09', name: 'JWT Token Exploitation', difficulty: 'Uzman', desc: 'JWT zafiyetleri: none algorithm, key confusion.', users: 510, points: 150, premium: true },
    ]
  },
  {
